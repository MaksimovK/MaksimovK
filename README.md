...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kmakismov@yandex.ru)

</div>

### 💼 Обо мне

Fullstack-разработчик с коммерческим опытом создания мобильных и веб-приложений. Фокусируюсь на эффективных решениях с использованием современных технологий. Ценю чистый код, производительность и удобство пользователя.
...
- 📱 **Брозэкс** (апрель 2024 — декабрь 2025):  
  Полноценное B2B-приложение на React Native: архитектура, ключевые модули (каталог, корзина, поиск с автоподсказками, оформление заказа, синхронизация с вебом), интеграции (AnyQuery, Dadata, Яндекс.Карты). Сокращение времени поиска на 25%, ускорение согласований на 30%.
- 🌐 **IntraVision** (август — сентябрь 2025):  
  Развитие веб-приложения на Next.js: текстовый редактор (Lexical), рефакторинг drag-and-drop (@atlaskit/pragmatic-drag-and-drop), оптимизация загрузки и отзывчивости интерфейса.
- 🛠️ **Фриланс** (октябрь 2023 — апрель 2024):  
  Адаптивная верстка от лендингов до федеральных проектов (СВОП, медицинские системы) с использованием семантического HTML5, CSS3 (Grid/Flexbox), vanilla JS.
...
<div align="start">
  ...
  <a href="https://www.typescriptlang.org/" target="_blank" rel="noreferrer">
    <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/typescript-colored.svg" width="50" height="50" alt="TypeScript" title="TypeScript"/>
  </a>
  <a href="https://nodejs.org/" target="_blank" rel="noreferrer">
    <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/nodejs-colored.svg" width="50" height="50" alt="Node.js" title="Node.js"/>
  </a>
  ...
  <a href="https://nextjs.org/" target="_blank" rel="noreferrer">
    <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/nextjs-colored.svg" width="50" height="50" alt="Next.js" title="Next.js"/>
  </a>
...
✨ Открыт к интересным задачам в формате fullstack-разработки.  
📍 Екатеринбург | 🌍 Удалёнка / гибрид | 📩 Предпочитаю связь через Telegram
